...
public class RemoveItemTest {
    ...
    public void setup() {
        ...
        product = new BarcodedProduct(barcode, "Test Product", 10, 100.0); // Example data
    ...
    public void removeItemTest() {
        // Set initial state
    	BigDecimal initialTotalCost = userSession.getTransaction().getTotalCost();
        Mass initialExpectedMass = userSession.getTransaction().getExpectedMass();
